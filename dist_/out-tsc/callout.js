...
export var Callout = (function () {
    function Callout(container, config) {
    ...
    Object.defineProperty(Callout.prototype, "config", {
        get: function () {
            return this._config;
        },
        enumerable: true,
    ...
    Callout.prototype.updateLayout = function (bodyDrag) {
        if (bodyDrag === void 0) { bodyDrag = false; }
    ...
    Callout.prototype.updatePosition = function (bodyDrag, show) {
        if (bodyDrag === void 0) { bodyDrag = false; }
