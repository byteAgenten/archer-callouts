...
export var AnchorView = (function () {
    function AnchorView(_callout) {
        ...
        this._offset = new Point(-0.5, 0.5);
        ...
        if (this._callout.config.customClass != null)
            addClass(this._anchorEl, this._callout.config.customClass);
    }
    ...
    AnchorView.prototype.calculateLayout = function () {
        var el = this._callout.connector.anchor.element;
        if (el.getBBox) {
        ...
        var anchorCenter = new Point(this._layoutData.boundElementRect.x2 + this._layoutData.boundElementRect.width * this._offset.x, this._layoutData.boundElementRect.y1 + this._layoutData.boundElementRect.height * this._offset.y);
